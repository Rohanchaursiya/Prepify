    ...
    <div className="marathon-container">
      ...
      <div className="marathon-tabs">
        <div className={`tab ${activeTab === 'topics' ? 'active' : ''}`} onClick={() => setActiveTab('topics')}>
          Important Topics
          {activeTab === 'topics' && <motion.div className="active-tab-indicator" layoutId="active-pill" />}
        </div>
        <div className={`tab ${activeTab === 'questions' ? 'active' : ''}`} onClick={() => setActiveTab('questions')}>
          Practice Questions
          {activeTab === 'questions' && <motion.div className="active-tab-indicator" layoutId="active-pill" />}
        </div>
      </div>
